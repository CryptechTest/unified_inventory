...
ui.register_page("craftguide", {
	get_formspec = function(player, perplayer_formspec)
		...
		formspec[n] = string.format("label[%f,%f;%s]", craftguidearrowx + 0.15, craftguidey + 1.4,
			F(craft_type.description))
		n = n + 1
		...
		if craft_type.uses_crafting_grid and display_size.width <= 3 then
			formspec[n]     = "label[" ..
				(give_x + 0.1) .. "," .. (craftguidey + 1.7) .. ";" .. F(S("To craft grid")) .. "]"
			formspec[n + 1] = "button[" .. (give_x) .. "," .. (craftguidey + 1.9) .. ";0.75,0.5;craftguide_craft_1;1]"
			formspec[n + 2] = "button[" .. (give_x + 0.8) ..
				"," .. (craftguidey + 1.9) .. ";0.75,0.5;craftguide_craft_10;10]"
			formspec[n + 3] = "button[" ..
				(give_x + 1.6) .. "," .. (craftguidey + 1.9) .. ";0.75,0.5;craftguide_craft_max;" .. F(S("All")) .. "]"
			n               = n + 4
		end
